...
class PdfLogic extends Logic
{
    ...
    public function applyTransfer($apply)
    {
        ...
        $arrInfo = [
            ...
            'old_base_salary' => $apply->applyTransfer->old_base_salary,
            'old_jixiao' => $apply->applyTransfer->old_jixiao,
            'target_org_name' => $apply->applyTransfer->target_org_name,
            'target_base_salary' => $apply->applyTransfer->target_base_salary,
            'target_jixiao' => $apply->applyTransfer->target_jixiao,
